...
public interface MouseEvent extends UIEvent {
    ...
    /**
     * <code>altKey</code> indicates whether the 'alt' key was depressed 
     ...
     * to a UI event.  Currently this property is used with the mouseover 
     * event to indicate the <code>Node</code> which the pointing device 
     * exited and with the mouseout event to indicate the  <code>Node</code> 
